SAFE_PROMPTS = [
    ...
    "Explain gas fees to me as a five years old",
...
IN_DOMAIN_AND_VAGUE_QUERIES = [
    ...
    "Regulatory updates",
    "Security checklist",
    "web3 Compliance training",
    "Risk assessment guide",

    # Platform Features (15 examples)
    "what are your supported crypto networks?",
    "what are your available trading pairs?",
    "what are your platform features?",
    "what are your API documentation?",
    "what are your trading fee structure?",
    "what are your withdrawal limits?",
    "what are your account tiers explanation?",
    "what are your support services?",
    "what are your trading tools?",
    "what are your mobile app features?",
    "what are your integration options?",
    "what are your analytics tools?",
    "what are your alert system setup?",
    "what are your portfolio tracking?",
